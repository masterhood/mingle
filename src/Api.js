...
class Api {
    ...
    /**
     * Copy a directory to a new location. This is identical to mix.copy().
     *
     * @param {string} from
     * @param {string} to
     */
    ...
    /**
     * Register vendor libs that should be extracted. This helps drastically with long-term caching.
     *
     * @param {Array}  libs
     * @param {string} output
     */
    ...
    /**
     * Register libraries to automatically "autoload" when the appropriate variable is references in your JS.
     *
     * @param {Object} libs
     */
    autoload(libs) {
