 ...
 *
 * Ofcold Rally provides a clean, fluent API for defining basic webpack build steps for your Ofcold application. Rally
 * supports a variety of common CSS and JavaScript pre-processors out of the box.
 */
